...
export const solutions: SolutionContent[] = [
  {
    ...
    metaDescription:
      "Custom ERP software for finance, inventory, and operations. Nexus Software builds scalable enterprise resource planning systems.",
    heroImage: img(
  ...
  },
  {
    ...
    metaDescription:
      "Custom CRM development for sales pipelines, account management, and customer success. Built by Nexus Software.",
    heroImage: img(
  ...
  },
  {
    ...
    metaDescription:
      "Custom AI agents for support, sales, and operations. RAG, tool use, and safe deployment by Nexus Software.",
    heroImage: img(
  ...
  },
  {
    ...
    metaDescription:
      "Custom HRMS software for employee management, leave, and HR workflows. Nexus Software builds people platforms.",
    heroImage: img(
  ...
  },
  {
    ...
    metaDescription:
      "Inventory management software for warehouses and retail. Real-time stock tracking by Nexus Software.",
    heroImage: img(
  ...
  },
  {
    ...
    metaDescription:
      "Custom e-commerce platform development. Storefronts, checkout, and admin by Nexus Software.",
    heroImage: img(
  ...
  },
  {
    ...
    metaDescription:
      "Custom business analytics dashboards and BI tools. Data visualization by Nexus Software.",
    heroImage: img(
      "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=75",
  ...
  },
  {
    ...
    metaDescription:
      "Workflow automation software for approvals and business processes. Built by Nexus Software.",
    heroImage: img(

    ...
    >
      ...
      <div className={cn(container, sectionPad, "relative")}>
        <SectionHeading
          ...
          description="Straightforward answers about how we work, what we build, and what to expect."
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:gap-10">
          <Reveal className="lg:col-span-4 lg:pt-1">
            ...
            >
              ...
              <p className={cn(overline, "mt-5")}>Need more detail?</p>
              <h3 className="mt-2 font-heading text-2xl font-medium leading-snug text-horizon-navy">
                We&apos;re happy to walk through your scenario
              </h3>
              <p className="mt-3 text-sm leading-relaxed text-horizon-muted">
                Every product is different. Tell us about your goals and we&apos;ll share how
                we&apos;d approach discovery, delivery, and launch.
              </p>

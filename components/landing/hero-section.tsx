          ...
          <div className="min-w-0 max-w-none lg:max-w-[58rem] xl:max-w-[64rem]">
            ...
            <Reveal immediate delay={motionStagger * 3}>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                <Link href={contactPath} className={`${btnPrimary} gap-2`}>
                  {homeHero.primaryCta} <ArrowRight className="size-4" aria-hidden />
                </Link>
                <Link href={homeHero.secondaryHref} className={`${btnOutlineDark} gap-2`}>
                  {homeHero.secondaryCta} <ArrowRight className="size-4" aria-hidden />
                </Link>
              </div>
            </Reveal>
          </div>

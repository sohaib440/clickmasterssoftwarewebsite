...
const variantIconClass = {
  onLight:
    "size-8 border-black/10 bg-black/5 text-black/70 hover:border-black/20 hover:bg-black/10 hover:text-black",
  onDark:
    "size-10 border-white/20 bg-white/10 text-white/80 hover:border-white/30 hover:bg-white/15 hover:text-white",
} as const;

...
export const pakistanCities: LocationCity[] = [
  {
    ...
    label: "Software house and software development company in Islamabad",
  ...
  },
  {
    ...
    label: "Software house and software development company in Lahore",
  ...
  },
  {
    ...
    label: "Software house and software development company in Faisalabad",
  ...
  },
  {
    ...
    label: "Software house and software development company in Multan",
  ...
  },
  {
    ...
    label: "Software house and software development company in Karachi",
  ...
  },
  {
    ...
    label: "Software house and software development company in Peshawar",
    href: cityLocationHref("peshawar"),
    city: "Peshawar",
    blurb: "Reliable web apps and internal tools for KPK organizations.",
  },
  {
    slug: cityLocationSlug("azad-jammu-and-kashmir"),
    label: "Software house and software development company in Azad Jammu and Kashmir",
    href: cityLocationHref("azad-jammu-and-kashmir"),
    city: "Azad Jammu and Kashmir",
    blurb: "Regional software delivery for businesses, institutions, and service teams across Azad Jammu and Kashmir.",
  },
  {
    slug: cityLocationSlug("gilgit-baltistan"),
    label: "Software house and software development company in Gilgit-Baltistan",
    href: cityLocationHref("gilgit-baltistan"),
    city: "Gilgit-Baltistan",
    blurb: "Reliable digital products and operational systems for organizations across Gilgit-Baltistan.",
  },
  {
    slug: cityLocationSlug("balochistan"),
    label: "Software house and software development company in Balochistan",
    href: cityLocationHref("balochistan"),
    city: "Balochistan",
    blurb: "Custom software, automation, and business systems for teams across Balochistan.",
  },
];
type PlaceFocus = {
  economy: string;

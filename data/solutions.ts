...
export const solutions: SolutionContent[] = [
	{
		...
		features: [
			{ title: "Single source of truth", description: "Unify finance, inventory, purchasing, sales, HR, and operations in one platform instead of scattered spreadsheets and disconnected tools." },
			{ title: "Workflow automation", description: "Automate approvals, notifications, assignment rules, and repetitive business logic to reduce admin work and improve consistency." },
			{ title: "Executive visibility", description: "Give leadership dashboards, analytics, and live reporting across departments so decisions are made using current business data." },
		],
		capabilities: [
		...
		useCases: [
			{ title: "Manufacturing businesses", description: "Connect production planning, warehouse activity, supplier orders, inventory, and finance in a single operating system." },
			{ title: "Distribution and retail groups", description: "Track stock, transfers, branches, customers, orders, and financial performance from one platform and one set of numbers." },
			{ title: "Professional services", description: "Link project costing, employee activity, expense control, procurement, invoicing, and reporting to a unified business model." },
		],
		highlights: [
